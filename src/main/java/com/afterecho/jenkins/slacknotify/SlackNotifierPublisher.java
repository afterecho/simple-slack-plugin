...
public class SlackNotifierPublisher extends Publisher implements SimpleBuildStep {

    private final static Logger LOG = Logger.getLogger(SlackNotifierPublisher.class.getName());

    private SlackStepDelegate slackStepDelegate;

    @DataBoundConstructor
    public SlackNotifierPublisher(String message, String webhookUrl, String channel) {
        slackStepDelegate = new SlackStepDelegate(message, webhookUrl, channel);
    }

    @Deprecated
    protected SlackNotifierPublisher() {
    }
